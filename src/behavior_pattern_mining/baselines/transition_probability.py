...
from experiment_config import (
    ...
    DAYS,
    HAMMING_THRESHOLD,
    MAX_SEQUENCE_LENGTH as CONFIG_MAX_SEQUENCE_LENGTH,
    MIN_SEQUENCE_LENGTH as CONFIG_MIN_SEQUENCE_LENGTH,
    N_STATES,
    ROOT_DIR,
    TIME_MODES,
    TRANSITION_ALLOW_REVISIT,
...
MODE_NAMES = list(TIME_MODES.keys())
THRESHOLD = TRANSITION_PROBABILITY_THRESHOLD  # 遷移確率の閾値（これ以上のものを選択）
MIN_SEQUENCE_LENGTH = CONFIG_MIN_SEQUENCE_LENGTH  # 最小系列長（ノード数）
MAX_SEQUENCE_LENGTH = CONFIG_MAX_SEQUENCE_LENGTH  # 最大系列長（ノード数）
EXCLUDED_STATES = TRANSITION_EXCLUDED_STATES
